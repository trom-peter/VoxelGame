...
FloatingCameraController::FloatingCameraController(FloatingCamera& camera) : camera(camera) {}

void FloatingCameraController::handleInputs(InputHandler* ih, float delta) {
